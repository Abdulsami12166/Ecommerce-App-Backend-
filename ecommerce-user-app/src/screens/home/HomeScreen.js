...
const HomeScreen = ({ navigation }) => {
   ...
   <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          {featuredImage ? <Image source={{ uri: featuredImage }} style={styles.featuredImage} /> : null}
        </TouchableOpacity>
  ...
  // Note: minimal change for dropdown behavior.
  // Full menu dropdown UI is implemented in the next pass (to avoid broad refactors now).
